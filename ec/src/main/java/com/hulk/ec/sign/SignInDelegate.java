...
public class SignInDelegate extends HulkDelegate implements View.OnClickListener {
            ...
            RestClient.builder()
                    ...
                    .success(new ISuccess() {
                        ...
                        public void onSuccess(String response) {
                            Toast.makeText(Hulk.getApplicationContext(), "登录！！！", Toast.LENGTH_LONG).show();
                    ...
                    .failure(new IFailure() {
                        ...
                        public void onFailure() {
                            Toast.makeText(Hulk.getApplicationContext(), "登录失败了！！！", Toast.LENGTH_LONG).show();
